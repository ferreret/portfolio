  ...
  return (
    <div className="pt-24 pb-20 animate-fade-in min-h-screen bg-white dark:bg-warm-900 transition-colors duration-300">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <button onClick={() => navigate('/blog', { viewTransition: true })} className="mt-8 mb-8 flex items-center gap-2 text-warm-500 dark:text-warm-400 hover:text-accent-700 dark:hover:text-accent-400 transition-colors text-sm">
          <ArrowLeftIcon />
          {data.ui.backToBlog}
        </button>
