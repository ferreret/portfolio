...
const contentEn = `
      ...
      <img src="/reactor-classifier/04-eda-graficos.webp" alt="Bar chart from the demo's EDA page: production orders per reactor (medium, large, small), split by correct vs incorrect viscosity outcome" width="1440" height="900" loading="lazy" class="w-full rounded-lg my-6" />
      ...
      <img src="/reactor-classifier/02-prediccion.webp" alt="Prediction page of the live demo: product code 629915 at 800 kg returns 18.05% reprocess probability in the large reactor and 24.77% in the medium reactor, with a capacity warning for the small one" width="1440" height="900" loading="lazy" class="w-full rounded-lg my-6" />
...
const contentEs = `
      ...
      <img src="/reactor-classifier/04-eda-graficos.webp" alt="Gráfico de barras de la página de EDA de la demo: órdenes de producción por reactor (mediano, grande, pequeño), divididas según viscosidad correcta o incorrecta" width="1440" height="900" loading="lazy" class="w-full rounded-lg my-6" />
      ...
      <img src="/reactor-classifier/02-prediccion.webp" alt="Página de predicción de la demo viva: el código de producto 629915 con 800 kg devuelve un 18,05% de probabilidad de reprocesado en el reactor grande y un 24,77% en el mediano, con aviso de capacidad para el pequeño" width="1440" height="900" loading="lazy" class="w-full rounded-lg my-6" />
